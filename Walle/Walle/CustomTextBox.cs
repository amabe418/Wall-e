    ...
    public partial class CustomTextBox : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (GraphicsPath path = new GraphicsPath())
            {
                ...
                path.AddLine(rect.X + 2*radius, rect.Height, rect.Width, rect.Height);
                path.AddLine(rect.Width, rect.Height, rect.Width, rect.Y);
                path.AddLine(rect.Width, rect.Y, rect.X + radius, rect.Y);
