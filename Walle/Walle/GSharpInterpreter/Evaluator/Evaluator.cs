    ...
    public class Evaluator
    {
        ...
        private void EvaluateDraw(DrawStatement draw)
        {
            ...
            void DrawFigure(GSharpFigure figure, string _label = "")
            {
                ...
                {
                    case Point point:
                        Interpreter.UI.DrawPoint(point, Scope.GetColor(), _label);
                        break;
                    case Line line:
                        Interpreter.UI.DrawLine(line, Scope.GetColor(), _label);
                        break;
                    case Segment segment:
                        Interpreter.UI.DrawSegment(segment, Scope.GetColor(), _label);
                        break;
                    case Ray ray:
                        Interpreter.UI.DrawRay(ray, Scope.GetColor(), _label);
                        break;
                    case Circle circle:
                        Interpreter.UI.DrawCircle(circle, Scope.GetColor(), _label);
                        break;
                    case Arc arc:
                        Interpreter.UI.DrawArc(arc, Scope.GetColor(), _label);
                        break;
                }
            }
            ...
            if (expressionToDraw is FiniteSequence sequence)
            {
                ...
                {
                    if (!(Evaluate(element) is GSharpFigure))
